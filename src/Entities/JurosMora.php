...
class JurosMora implements HasPayloadInterface
{
    ...
    public function getTipo(): JurosMoraTipo
    {
        return $this->tipo;
    }

    public function setTipo(JurosMoraTipo $tipo): self
    {
        $this->tipo = $tipo;
        $this->validate();
        return $this;
