...
class AbatimentoAplicado implements HasPayloadInterface
{
    ...
    public function __construct(
        private ModalidadeAbatimentoAplicado $modalidade,
    ...
    public function getModalidade(): ModalidadeAbatimentoAplicado
    {
        return $this->modalidade;
    }

    public function setModalidade(ModalidadeAbatimentoAplicado $modalidade): self
    {
