...
class JuroAplicado implements HasPayloadInterface
{
    ...
    public function __construct(
        private ModalidadeJuroAplicado $modalidade,
    ...
    public function getModalidade(): ModalidadeJuroAplicado
    {
        return $this->modalidade;
    }

    public function setModalidade(ModalidadeJuroAplicado $modalidade): self
    {
